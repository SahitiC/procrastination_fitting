...
# %%
input_params_recovery = np.load("input_params_recovery.npy", allow_pickle=True)
recovery_em = np.load("recovery_em.npy", allow_pickle=True).item()
recovery_individual_mle = np.load("recovery_individual_mle.npy",
                                  allow_pickle=True)
recovery_group_mle = np.load("recovery_group_mle.npy", allow_pickle=True).item()
