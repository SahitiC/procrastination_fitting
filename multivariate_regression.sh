...
cp ${SLURM_SUBMIT_DIR}/zhang_ma_data.csv ${SCRATCH_DIRECTORY}
cp ${SLURM_SUBMIT_DIR}/fit_individual_mle_with_hess.npy ${SCRATCH_DIRECTORY}
cp ${SLURM_SUBMIT_DIR}/regression.py ${SCRATCH_DIRECTORY}
cp ${SLURM_SUBMIT_DIR}/multivariate_regression.py ${SCRATCH_DIRECTORY}
